 ...
 * 
 */
@WebServiceClient(name = "NewWebService", targetNamespace = "http://Test/", wsdlLocation = "http://localhost:8080/mavenproject1/NewWebService?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/mavenproject1/NewWebService?wsdl");
